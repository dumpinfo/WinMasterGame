...
GENESISAPI geBitmap_Palette * 	GENESISCC	geBitmap_GetPalette(geBitmap *Bmp);
GENESISAPI geBoolean			GENESISCC	geBitmap_SetPalette(geBitmap *Bmp, geBitmap_Palette *Palette);
...
*		doing different SetPalettes to different locked mips has undefined behavior!
*
**/
...
GENESISAPI geBoolean		GENESISCC	geBitmap_Palette_GetEntryColor(geBitmap_Palette *P,int Color,int *R,int *G,int *B,int *A);
...
GENESISAPI geBoolean		GENESISCC	geBitmap_Palette_GetEntry(geBitmap_Palette *P,int Color,uint32 *Pixel);
