...
INT WINAPI WinMain( HINSTANCE hInst, HINSTANCE, LPSTR strCmdLine, INT )
{
    ...
    // means the display must be 16- or 256-color mode.
...
HRESULT Initialize3DEnvironment( HWND hWnd )
{
    ...
    // Create a new CD3DFramework class. This class does all of the D3D
...
HRESULT Change3DEnvironment( HWND hWnd )
{
    ...
    // Inform the framework class of the driver change.
